...
filter = np.reshape(np.asarray(signal.get_window(('gaussian', cutoff_frequency), cutoff_frequency*4+1)), (cutoff_frequency*4+1, 1)) ;#insert values from fspecial('Gaussian', cutoff_frequency*4+1, cutoff_frequency) here
